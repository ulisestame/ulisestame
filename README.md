...
<p align="center">
  <img src="https://skillicons.dev/icons?i=py,fastapi,postgres,docker,aws,react,ts,js,nodejs,git,githubactions,html,css,linux&perline=7" alt="Tech Stack"/>
</p>
...
Most teams struggle with AI not because their models are wrong — but because the backend can't support it in production. I work at that intersection: building the APIs, data pipelines, and infrastructure that make AI features reliable and maintainable.
...
- AI guardrails and structured outputs
- Backend observability for LLM applications
- Self-hosted infrastructure with Docker & Coolify
